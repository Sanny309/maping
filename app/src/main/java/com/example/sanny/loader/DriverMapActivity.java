...
public class DriverMapActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
        ...
        assignedCustomerRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    getAssignedCustomerPickupLocatiion();
    ...
    private void getAssignedCustomerPickupLocatiion() {
    ...
    public void onLocationChanged(Location location) {
        if (getApplicationContext() != null) {
            ...
            DatabaseReference refAvilable = FirebaseDatabase.getInstance().getReference("driverAvilable");
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("DriverMap Page") // TODO: Define a title for the content shown.
